...
def letter_stat(our_str):
    """
    Функция на вход принимает строку и возвращает словарь.
    :param our_str: принимаемая строка "our_str"
    ...
    for key in our_str:
        ...
        dicts = dict.fromkeys(key, values)  # Создаем словарь с парой ключ: значение
        letters_dict.update(dicts)  # Обновляем словарь новым значением у ключа
    return letters_dict
